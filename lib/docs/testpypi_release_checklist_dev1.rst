TestPyPI publication checklist for 0.0.2.dev1
==============================================

Status
------

Published on TestPyPI. Version ``0.0.2.dev1`` is available at:

* https://test.pypi.org/project/multigit-lib/0.0.2.dev1/

Artifacts prepared
------------------

* dist/multigit_lib-0.0.2.dev1-py3-none-any.whl
* dist/multigit_lib-0.0.2.dev1.tar.gz
...
Publication command bundle (executed for 0.0.2.dev1)
-----------------------------------------------------
